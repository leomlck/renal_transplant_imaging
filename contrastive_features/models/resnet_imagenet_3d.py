...
def resnet18_3d_imagenet(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet50_3d_imagenet(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
